...
const Navigation = () => {
    ...
    return (
        <div className="navbar bg-secondary md:container md:mx-auto relative top-10">
            ...
            <div className="navbar-end">
                <button className='btn btn-primary rounded-none text-white text-lg hover:bg-base-100 hover:text-primary'>Have Any Questions?</button>
